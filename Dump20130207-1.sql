...
INSERT INTO `borda` VALUES (1,'Delicia hein','Cheddar',5),(2,'gordisse','catupery',4);
...
INSERT INTO `colaborador` VALUES ('05540130960',123456,'123456789','6167558',2000000,1,1),('345636',0,'345635','5678',746,10,10),('6',0,'6','6',6,14,11),('61',0,'61','61',61,15,11),('456',0,'456','456',456,16,12);
...
INSERT INTO `endereco` VALUES (1,'bairro teste','88000000','cidade teste',NULL,'rua teste',1),(6,'fgjfgh','457457','asdf','hjljdh','fbgh',10),(10,'6','6','6','6','6',14),(11,'61','61','61','61','61',15),(12,'456','456','456','456','456',16);
...
INSERT INTO `funcao` VALUES (1,'presidente','presidente'),(10,NULL,'dh'),(11,'Faz os rangos','Cozinheiro'),(12,'eh quem ta fazendo a bagaca toda','Programador');
...
INSERT INTO `pessoa` VALUES (1,'88998899','1986-11-14','Lucio Cesar M Consul','33443344'),(10,'564567','2013-02-12','1234','34563456'),(14,'6','2013-02-06','6','6'),(15,'61','2013-02-06','61','61'),(16,'456','2013-02-07','mais um teste','456');
...
INSERT INTO `sabor` VALUES (1,'mussarela, parmesao, prato e catupiry','Quatro queijos',28,22,18),(2,'ClÃ¡ssica','Calabresa',27,22,16);
...
CREATE TABLE `sabor_pizza` (
  ...
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id_pizza`,`id`),
  KEY `FK7663BF0075A9F458` (`id_sabor`),
  KEY `FK7663BF00755D63FA` (`id_pizza`),
  CONSTRAINT `FK7663BF00755D63FA` FOREIGN KEY (`id_pizza`) REFERENCES `pizza` (`id`),
  CONSTRAINT `FK7663BF0075A9F458` FOREIGN KEY (`id_sabor`) REFERENCES `sabor` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tamanho` VALUES (1,'32','Grande'),(2,'28','Media');
...
INSERT INTO `usuario` VALUES (1,'lucioconsul','senhateste',1,1),(7,'asdf','1234',10,7),(11,'6','6',14,11),(12,'61','61',15,7),(13,'456','456',16,1);
...
-- Dump completed on 2013-02-07 22:15:45
