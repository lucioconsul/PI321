...
INSERT INTO `menus` VALUES (2,'ui-icon-pencil',NULL,'Pedido','admin.faces'),(3,'ui-icon-comment','2','Fazer Pedido','admin.faces'),(4,'ui-icon-heart','2','Cliente','admin.faces'),(5,'ui-icon-cart',NULL,'Produto',NULL),(6,'ui-icon-check','5','Pizza','admin.faces'),(7,'ui-icon-check','5','Tamanho','admin.faces'),(8,'ui-icon-check','5','Borda','admin.faces'),(9,'ui-icon-check','5','Sabores','admin.faces'),(10,'ui-icon-check','5','Bebida','admin.faces'),(11,'ui-icon-person',NULL,'Usuarios',NULL),(12,'ui-icon-document','11','Colaborador','cadFuncionario.faces'),(13,'ui-icon-wrench','11','Funções','cadFuncao.faces');
...
-- Dump completed on 2013-02-06 23:44:42
